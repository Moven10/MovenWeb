document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", async function (event) {
        ...
        const formData = { email, company, firstName, lastName, workType, employees, country, budget, goals, referral };
        ...
        try {
            const response = await fetch("https://alpaca-bursting-koala.ngrok-free.app/register-partner", {
                method: "POST",
            ...
            if (response.ok) {
                showMessage("Thank You for your interest, check your email for your confirmation", "success");
