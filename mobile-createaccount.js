document.addEventListener("DOMContentLoaded", () => {
    ...
    usernameInput.addEventListener("input", async () => {
        ...
        try {
            const response = await fetch("https://alpaca-bursting-koala.ngrok-free.app/check-username", {
                method: "POST",
                headers: {
    ...
    signupForm.addEventListener("submit", async (event) => {
        ...
        try {
            const response = await fetch("https://alpaca-bursting-koala.ngrok-free.app/send-email", {
                method: "POST",
