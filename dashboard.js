...
if (followingTitle) {
    ...
    async function loadUserData() {
        const url = `https://alpaca-bursting-koala.ngrok-free.app/get-user-details?username=${username}`;
        try {
    ...
    async function loadTotalDistance() {
        const url = `https://alpaca-bursting-koala.ngrok-free.app/get-total-distance?username=${username}`;
        try {
            const response = await fetch(url);
    ...
    async function fetchFollowers() {
        const url = `https://alpaca-bursting-koala.ngrok-free.app/get-followers?username=${username}`;
        try {
            const response = await fetch(url);
    ...
    async function fetchFollowingAccounts() {
        const url = `https://alpaca-bursting-koala.ngrok-free.app/get-followed-accounts?username=${username}`;
        try {
            const response = await fetch(url);
    ...
    async function loadClaimedImages() {
        const url = `https://alpaca-bursting-koala.ngrok-free.app/get-claimed-sneakers?username=${username}`;
        try {
            const response = await fetch(url);
